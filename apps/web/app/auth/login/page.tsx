        ...
        <form className="space-y-4">
          ...
          <div className="flex gap-2">
            <button
              onClick={handleLogin}
              disabled={loading}
              className="flex-1 bg-[#14B8A6] text-white py-2 px-4 rounded-md hover:bg-[#0D9488] transition-colors disabled:opacity-50"
            >
              Connexion
            </button>
            <button
              ...
              disabled={loading}
              className="flex-1 bg-[#F97316] text-white py-2 px-4 rounded-md hover:bg-[#EA580C] transition-colors disabled:opacity-50"
            >
              Inscription
            </button>
          </div>
